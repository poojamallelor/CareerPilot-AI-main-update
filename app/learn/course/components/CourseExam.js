        ...
        <div className="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-2xl text-center">
          ...
          <div className="space-y-4">
            {answers.map((answer, index) => (
              <div
                key={index}
                className={`p-4 rounded-lg flex items-center ${answer.correct ? "bg-green-100" : "bg-red-100"
                  }`}
              >
                {answer.correct ? (
          ...
          {score >= passingScore ? (
            ...
            <>
              ...
              <Button
                ...
                className="mt-6 bg-blue-600 text-foreground px-6 py-3 rounded-lg hover:bg-blue-700 transition duration-300"
              >
                How to Improve
              </Button>
          ...
          {score >= 75 && (
            <button className="mt-6 bg-blue-600 text-foreground px-6 py-3 rounded-lg hover:bg-blue-700 transition duration-300">
              Completed
            </button>
          )}
        </div>
    ...
    <div className="min-h-screen bg-blue-50 flex items-center justify-center p-4">
      <div className="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-2xl">
          ...
          <div className="space-y-4">
            {exam.mcqs[currentQuestion].options.map((option, index) => (
              <button
                ...
                className={`w-full text-left p-4 rounded-lg transition duration-300 ${selectedOption === option
        ...
        <button
          ...
          className={`w-full py-3 rounded-lg transition duration-300 ${selectedOption
