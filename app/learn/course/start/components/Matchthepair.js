...
//           className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-foreground px-6 py-2 rounded-full shadow-lg transform transition-all hover:scale-105"
//         >
...
//               <Button
//                 onClick={shuffleCards}
//                 className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-foreground px-8 py-3 rounded-full shadow-lg transform transition-all hover:scale-105"
//               >
//                 Play Again
//               </Button>
//             </div>
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 max-w-6xl mx-auto bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen">
      <div className="text-center mb-4 sm:mb-6 md:mb-8">
        ...
        <Button
          onClick={shuffleCards}
          className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-foreground px-4 sm:px-5 md:px-6 py-1 sm:py-2 rounded-full shadow-lg transform transition-all hover:scale-105 text-sm sm:text-base"
        >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-2xl transform animate-fadeIn w-full max-w-md">
            <div className="text-center">
              ...
              <Button
                onClick={shuffleCards}
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-foreground px-6 sm:px-7 md:px-8 py-2 sm:py-3 rounded-full shadow-lg transform transition-all hover:scale-105 text-sm sm:text-base"
              >
                Play Again
              </Button>
            </div>
