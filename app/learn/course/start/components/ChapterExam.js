...
//           <CardHeader className="bg-blue-600 text-foreground">
...
//             {score >= exam.length * 0.7 ? (
//               <Button
//                 className="w-full bg-primary hover:opacity-90 text-foreground"
//                 onClick={() => {
//                   setComplete(true);
...
//               className="w-full mt-4 bg-primary hover:opacity-90 text-foreground"
//             >
...
function ChapterExam({ setRestart, setComplete, topicName }) {
  ...
  return (
    <div className="min-h-screen bg-blue-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl mx-auto">
        <CardHeader className="bg-blue-600 text-foreground p-6">
        ...
        <CardContent className="p-6">
          ...
          {selectedAnswer && (
            <Button
              onClick={moveToNextQuestion}
              className="w-full mt-6 bg-primary hover:opacity-90 text-foreground py-3"
            >
              {currentQuestion + 1 < exam.length
                ? "Next Question"
                : "Finish Exam"}
